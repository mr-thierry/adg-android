...
public class EllipsizingTextView extends TextView {
	...
	/**
	 * MaxLinesHolder: inner class qui contient la valeur de maxLines
	 * 
	 * Le problème, c'est que si c'est un int, la valeur est setté par le
	 * parents (dans setMaxLines) et ensuite initialisé à 0 par
	 * l'instanciantion de la class. La valeur reste donc toujours à 0. En
	 * utilisant un container, on s'assure que la valeur setté par le
	 * parent n'est pas overwritté lors de l'instanciation de
	 * EllipsizingTextView
	 */
